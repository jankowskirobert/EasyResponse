...
public class DemoEasyService implements EasyService {
	...
	@EasyRegistredAction(request = "demo_path_nope")
	public void simpleMethod() {
		try {
			EasyRequest request = new EasyRequest(context, new RequestConfigurationFactory());
			EasyResponse response1 = request.to("GUI/increase_value").sendSync().get();
	...
	@EasyRegistredAction(request = "demo_path_nope/args")
	...
	@EasyRegistredAction(request = "demo_path_nope/sleep")
	...
	@EasyRegistredAction(request = "demo_path_yep/ops")
